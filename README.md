...
<body><div class="gcse-search"></div><div id="profile" class="section active">
  ...
  <p><strong>Email:</strong> hmharun796@gmail.com</p>  <a href="mailto:hmharun123@gmail.com?subject=Hiring Request&body=Hello, I would like to hire you for a project." target="_blank">
...
</div><!-- Photo & Video Section --><div class="media-section">
...
</div><!-- Image Row --><div class="image-row">
...
</div><!-- Gallery Section --><div class="gallery-section">
  <h2>My Gallery</h2>
  <div class="gallery">
